...
<body>
	...
	<div id="sub">
		<div id="sub-left">
			...
			<ul>
				<li><a class="smenu" href="<%=R78%>/menu/smenu11.jsp">경영이념</a></li>
				<li><a class="smenu active" href="<%=R78%>/menu/smenu11.jsp">찾아오시는
						길</a></li>
			</ul>
		</div>
		...
		<div id="sub-right">
			<span class="svisual"> <img alt="서브아이콘"
				src="<%=R78%>/images/smenu12-icon.png" width="50" height="50"></img>
			</span>
			<p id="navi">
				Home > 회사소개 > 찾아오시는 길<span></span>
			</p>
			...
			<div id="content">
				...
				<div id="business-mid">
					<h3 id="sub-title" style="margin-bottom: 30px" class="crbold">


						찾아오시는 길 <span> 믿을수있는 수인 </span>
					</h3>
				<h3 style="text-align: center; font-size: 20px;">서울시 강동구 성내동 452-3. 신호빌라트 지하 1층</h3>

				<hr align="center" size="1" color=a1d82c>
					<!--
	* Daum 지도 - 약도서비스
...
-->
<!-- 1. 약도 노드 -->
<div id="daumRoughmapContainer1451226561192" class="root_daum_roughmap root_daum_roughmap_landing"></div>
