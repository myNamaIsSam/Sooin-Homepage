...
<body>
	...
	<div id="sub">
		<div id="sub-left">
			<h2>BUSINESS</h2>
			<ul>
				<li><a class="smenu active" href="<%=R78 %>/menu/smenu21.jsp">시설영역</a></li>
		...
		<div id="sub-right">
			<span class="svisual"> <img alt="서브아이콘"
				src="<%=R78 %>/images/smenu21-icon.png" width="50" height="50"></img>
			</span>
			<p id="navi">
				Home > 사업영역 > 시설영역 <span></span>
			</p>
			<h3 id="sub-title" class="crbold">


				시설영역 <span> 믿을수있는 수인 </span>
			</h3>
			<p></p>
			<div id="content">
				<div class="business-top clearfix">
					...
					<div class="business-top-right">
						<img alt="내용" src="<%=R78 %>/images/edit3.jpg" height=300px width=395px></img>
					</div>
