...
<body>
	...
	<div id="sub">
		<div id="sub-left">
            <%@ include file="/menu/smenu41-left.jsp" %>
		</div>
		<div id="sub-right">
			<span class="svisual"> 
			<img alt="서브아이콘"
				src="<%=R78 %>/images/smenu41-icon.png" width="50" height="50"></img>
			</span>
			<p id="navi">
				Home > 견적의뢰 <span></span>
			</p>
			<h3 id="sub-title" class="crbold">
				견적의뢰 <span> 믿을수있는 수인 </span>
			</h3>
			<p></p>
			<div id="content">
				<%@ include file="/board_job/boardConfirm2.jsp"%>
			</div>
		</div>
	</div>
